...
<nav class="w-full bg-slate-100 items-center gap-y-3">
            ...
            <div class="flex bg-slate-200 p-3">
                ...
                <div class="justify-evenly hidden w-full md:flex md:order-1" id="navbar-user">
                    <ul
                        ...
                        <li>
                            <a href="/"
                                class="@if (request()->is('/')) { text-[#ec3237] font-bold } @else text-gray-900 @endif block py-2 pl-3 pr-4 bg-[#ec3237] rounded md:bg-transparent md:hover:text-[#ec3237] md:p-0"
                        ...
                        <li>
                            <a href="/nosotros"
                                class="@if (request()->is('nosotros')) { text-[#ec3237] font-bold } @else text-gray-900 @endif block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#ec3237] md:p-0">Sobre
                                nosotros
                            </a>
                        </li>
                        <li>
                            <a href="/sucursales"
                                class="@if (request()->is('sucursales')) { text-[#ec3237] font-bold } @else text-gray-900 @endif block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#ec3237] md:p-0">
                                Sucursales
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('faqs.index') }}"
                                class="@if (request()->is('preguntas-frecuentes')) { text-[#ec3237] font-bold } @else text-gray-900 @endif block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#ec3237] md:p-0">Preguntas
                                frecuentes
                            </a>
                        </li>
                        <li>
                            <a href="/contacto"
                                class="@if (request()->is('contacto')) { text-[#ec3237] font-bold } @else text-gray-900 @endif block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#ec3237] md:p-0">Contacto
                            </a>
                        </li>
                    </ul>
                </div>
